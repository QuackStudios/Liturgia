(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [7458],
  {
    20688: (e, t, s) => {
          ...
          if ((t && "object" == typeof t) || "function" == typeof t)
            for (let a of o(t))
              h.call(e, a) ||
                ...
                i(e, a, {
                  get: () => t[a],
                  enumerable: !(r = n(t, a)) || r.enumerable,
                });
          return e;
        },
        d = (e, t, s) => (l(e, "symbol" != typeof t ? t + "" : t, s), s),
        u = {};
      ((e, t) => {
        for (var s in t) i(e, s, { get: t[s], enumerable: !0 });
      })(u, { default: () => L }),
        (e.exports = p(i({}, "__esModule", { value: !0 }), u));
      var c = ((e, t, s) => (
          (s = null != e ? r(a(e)) : {}),
          p(
            !t && e && e.__esModule
              ? s
              : i(s, "default", { value: e, enumerable: !0 }),
            e
          )
        ))(s(96540)),
        y = s(75635),
        f = s(50327);
      let E = "undefined" != typeof navigator,
        m =
          E &&
        ...
        P =
          ...
          !window.MSStream,
        g = /www\.dropbox\.com\/.+/,
        b = /https:\/\/watch\.cloudflarestream\.com\/([a-z0-9]+)/;
      class L extends c.Component {
        constructor() {
          super(...arguments),
            d(this, "onReady", (...e) => this.props.onReady(...e)),
            d(this, "onPlay", (...e) => this.props.onPlay(...e)),
            d(this, "onBuffer", (...e) => this.props.onBuffer(...e)),
            d(this, "onBufferEnd", (...e) => this.props.onBufferEnd(...e)),
            d(this, "onPause", (...e) => this.props.onPause(...e)),
            d(this, "onEnded", (...e) => this.props.onEnded(...e)),
            d(this, "onError", (...e) => this.props.onError(...e)),
            d(this, "onPlayBackRateChange", (e) =>
              this.props.onPlaybackRateChange(e.target.playbackRate)
            ),
            d(this, "onEnablePIP", (...e) => this.props.onEnablePIP(...e)),
            d(this, "onDisablePIP", (e) => {
            ...
            d(this, "onPresentationModeChange", (e) => {
              if (
                this.player &&
                (0, y.supportsWebKitPresentationMode)(this.player)
              ) {
        ...
        componentDidUpdate(e) {
          this.shouldUseAudio(this.props) !== this.shouldUseAudio(e) &&
            ...
            this.props.url === e.url ||
              (0, y.isMediaStream)(this.props.url) ||
        ...
        shouldUseAudio(e) {
          return (
            ...
            (f.AUDIO_EXTENSIONS.test(e.url) || e.config.forceAudio)
          );
        }
        shouldUseHLS(e) {
          return (
            (!!P && !!this.props.config.forceSafariHLS) ||
            !!this.props.config.forceHLS ||
            (!v &&
              !this.props.config.forceDisableHls &&
              (f.HLS_EXTENSIONS.test(e) || b.test(e)))
          );
        }
        shouldUseDASH(e) {
          return f.DASH_EXTENSIONS.test(e) || this.props.config.forceDASH;
        }
        shouldUseFLV(e) {
          return f.FLV_EXTENSIONS.test(e) || this.props.config.forceFLV;
        }
        load(e) {
          let {
            hlsVersion: t,
        ...
        getSource(e) {
          ...
          return e instanceof Array || (0, y.isMediaStream)(e) || t || s || r
            ? void 0
            : g.test(e)
      ...
      d(L, "displayName", "FilePlayer"), d(L, "canPlay", f.canPlay.file);
    },
  },
]);

  ...
  var t = {
      78: (t, e, r) => {
        ...
        t.exports = function (t, e) {
          if (!t) throw new Error("Missing elm");
          var r = {};
          return (
      ...
      54: (t, e, r) => {
        ...
        (c.prototype = {
          ...
          getParams: function () {
            var t = this,
              e = [],
              r = decodeURIComponent(this.options.returnTo),
              n = r.match(
                /(http:\/\/|https:\/\/)+(.*)(\/admin|\/agent|\/chat|\/connect|\/explore|\/sell|oauth\/)/
              );
            this.validParams.forEach(function (r) {
              t.options.hasOwnProperty(r) &&
                e.push(
                  "".concat(a(r), "=").concat(encodeURIComponent(t.options[r]))
                );
            }, this);
            var o =
              r.match(/(http:\/\/|https:\/\/)+(.*)(\/oauth\/)/) &&
              this.options.role;
            return n && !o && e.push("role=agent"), e.join("&");
          },
        }),
          (t.exports = c);
      },
      ...
      a = new (function () {
        if (
          ...
          (this.elm =
            ...
            document.querySelector('script[src*="/auth/v2"]')),
          !this.elm || "SCRIPT" !== this.elm.tagName)
        )
          throw new Error("Could not find script tag for zendesk_auth");
        if (
          ((this.declarativeOptions = i(this.elm, this.KEYS)),

(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [8792],
  {
    ...
    81156: (e, t, r) => {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }), r(39374);
      let n = r(9441);
      (window.next = {
        version: n.version,
        get router() {
        ...
        getMiddleware() {
          return (
            (window.__MIDDLEWARE_MATCHERS = [
              {
                regexp:
                  "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api|_next\\/static.*|scripts\\/sw.js|_next\\/data.*|android-chrome-192x192.png|android-chrome-256x256.png|_next\\/image|favicon.*|fonts|models|autodiscover).*))(\\.json)?[\\/#\\?]?$",
                originalSource:
                  "/((?!api|_next/static.*|scripts/sw.js|_next/data.*|android-chrome-192x192.png|android-chrome-256x256.png|_next/image|favicon.*|fonts|models|autodiscover).*)",
              },
              {
                regexp:
      ...
      class K {
        ...
        async change(e, t, r, n, o) {
          ...
          this._inFlightRoute &&
            this.clc &&
            (V ||
              K.events.emit("routeChangeError", D(), this._inFlightRoute, J),
            this.clc(),
            (this.clc = null)),
            (r = (0, S.addBasePath)(
              (0, P.addLocale)(
          ...
          if (!B && this.onlyAHashChange(Z) && !ee) {
            ...
            try {
              ...
              throw (
                ((0, u.default)(e) &&
                  e.cancelled &&
                  K.events.emit("routeChangeError", e, Z, J),
                e)
              );
            }
          ...
          try {
            ...
            if (
              ...
              if (
                ((q.isPreview = !!a.props.__N_PREVIEW), a.props.notFound === G)
              ) {
                let e;
                try {
            ...
            if (
              (K.events.emit("beforeHistoryChange", r, J),
              ...
              if (a.error)
                throw (
                  (B || K.events.emit("routeChangeError", a.error, Z, J),
                  a.error)
                );

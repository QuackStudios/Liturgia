      ...
      let d = (e) => {
        ...
        u = (e) => {
          let {
            ...
            m = (0, a.useRouter)(),
            h = (0, s.U)("only screen and (max-width: 640px)");
    ...
    24939: (e, n, t) => {
      ...
      let J = (e) => {
        ...
        let p =
          (null == h
            ? void 0
            : null === (n = h.mediaElement) || void 0 === n
            ? void 0
            : n[0]) || null;
        return (0, T.jsxs)("div", {
          className:
            ...
            eW.P.div,
            {
              ...
              children: [
                ...
                (0, T.jsx)("div", {
                  ...
                  dangerouslySetInnerHTML: { __html: e2()(n.text, e5.O) },
                }),
              ],
            },
            t
      ...
      let tx = {
          ...
          banner: (e) => {
            let { module: n } = e;
            return (0, T.jsx)(th.A, { module: n, anchor: n.anchor });
          },
          people: (e) => {
            let { module: n } = e,
              [t, l] = (0, B.useState)(null),
              [i] = (0, tp._)(ec._[0].query, {
                onCompleted: (e) => {
                  var t;
          ...
          let { className: a, globals: s } = e,
            ...
            { ancestors: p, level: g } = {
              ...
              ancestors: [
                ...
                {
                  uid: null == h ? void 0 : h.uid,
                  title: null == h ? void 0 : h.title,
                  url:
                    "string" == typeof (null == h ? void 0 : h.url)
                      ? null == h
                        ? void 0
                        : h.url
                      : null == h
                      ? void 0
                      : null === (r = h.link) || void 0 === r
                      ? void 0
                      : r.url,
                },
              ],
            };
          return 1 !== g && (null == p ? void 0 : p.length)
            ? (0, T.jsx)("div", {
                className:
        ...
        return (
          ...
          (0, T.jsxs)(T.Fragment, {
            children: [
              ...
              (0, T.jsx)(lb(), {
                src: "https://Liturgia.statuspage.io/embed/script.js",
              }),
                ...
                children: (0, T.jsx)(eW.P.div, {
                  ...
                  children: (0, T.jsxs)("form", {
                    ...
                    onSubmit: (e) => {
                      ...
                      let i = ""
                        .concat(
                          encodeURIComponent("".concat("Liturgia", "[query]")),
                          "="
                        )
      ...
      let is = {
        ...
        io = (e) => {
          let { globals: n, className: t, dark: l = !1 } = e,
            ...
            [o, d] = (0, B.useState)([]),
            [c, u] = (0, B.useState)(!1),
            [m, h] = (0, B.useState)(480),
            { data: p } = (0, M.I)(il(), {
              variables: { uri: s.uri, siteId: a.siteId },
            });
          return ((0, B.useEffect)(() => {
            let { localized: e } = (null == p ? void 0 : p.entry) || {};
            d(
              lM.sites.map((n) => {
                let t =
                    (null == e
        ...
        ip = (0, Z.WQ)("ui")(
          (0, Z.PA)((e) => {
            ...
            let { globals: a, ui: s } = e,
              ...
              [c, u] = (0, B.useState)([]),
              { currentSite: m } = a || {},
              { data: h } = (0, M.I)(ih, { variables: { siteId: m.siteId } });
            return (
              (0, B.useEffect)(() => {
                if (null == h ? void 0 : h.mainMenu) {
                  let e = () => {
      ...
      let iN = (e) => {
        ...
        let m = { currentSite: l, currentRoute: i, routeProps: r },
          { sectionHandle: h, typeHandle: p } = u || {},
          g = null === (n = _[h]) || void 0 === n ? void 0 : n[p];
        return g
          ? (0, T.jsxs)(T.Fragment, {
              children: [
                (0, T.jsx)(ij, {

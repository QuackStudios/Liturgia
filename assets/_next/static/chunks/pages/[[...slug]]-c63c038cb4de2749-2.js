      ...
      let tE = (e) => {
          ...
          return (0, T.jsx)("div", {
            ...
            children: (0, T.jsxs)("form", {
              ...
              onSubmit: (e) => {
                e.stopPropagation(), o.current && o.current.blur();
              },
              onReset: (e) => {
                e.stopPropagation(), c(""), o.current && o.current.focus();
              },
              children: [
                (0, T.jsx)("svg", {
                  width: "14",
        ...
        l_ = (0, Z.WQ)("ui")(
          (0, Z.PA)((e) => {
            ...
            return (0, T.jsx)("button", {
              ...
              className:
                "burger-button text-asphalt bg-white md:bg-transparent w-[2.875rem] group h-[2.875rem] rounded-full flex items-center justify-center z-60 transition-colors optional-hide".concat(
                  n.menuState ? "open" : ""
                ),
              onClick: () => {
          ...
          (0, U.E)(() => {
            i ||
              ...
              setTimeout(() => {
                ...
                (0, lC.setCookie)("__locationRedirect", "true", {
                  expires: l,
                });
              }, 2e3);
          }, [h, g, x]);
